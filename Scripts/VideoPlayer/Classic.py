...
classicLib = "https://master.thorhudl.com/library/196291"
...
time.sleep(5)
#pause player
pauseButton = driver.find_element_by_xpath("//*[@id='pause-button']")
pauseButton.click()
#get play time
playTime = driver.find_element_by_xpath("//*[@class='hp-time-position']")
getPausedRunTime = playTime.text.split(":")
getJustTheSeconds = getPausedRunTime[1].split(".")
currentPlayTime = int(getJustTheSeconds[0])
print("Playhead Time: " + str(currentPlayTime))

FullScreenButton = driver.find_element_by_xpath("//*[@class='hp-button fullscreen-button']")
