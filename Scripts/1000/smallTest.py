...
#load source video event page
driver.get(sourceVideo)
time.sleep(2)

#download the source file created mp4
driver.get("https://vtemp.hudl.com/thor/video-temp-10d/47313/275183/1f8/5ef0d7a3c2e10516302e71f8/5ef0d7a3c2e10516302e71f8.mp4")
...
driver.close()
#Start the loop that will go through lots of videos
...
while (downloadIsReady == False and maxDownloadRetries <=30):
    ...
    if isDownloadMP4Null == None:
        ...
        if getDownloadMp4Status == "Ready":
            ...
            break
        time.sleep(10)
    print("Waiting for Download Mp4")
